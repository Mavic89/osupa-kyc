 ...
 */
 exports.KYCVerification = functions.https.onRequest(async (req, res) => {
        ...
        var sdnResponse = await ofacScreening(userFirst,userLast.toUpperCase);
        KYCScore =KYCScore+sdnResponse;
        var PEPResponse= await PEPScreening(userFirst,userLast.toUpperCase);
        KYCScore =KYCScore+PEPResponse;
        var bankResponse= await bankAccount(bankNumber,"plaid access sandbox token");
